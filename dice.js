...
var Dice = function (command, rng) {
    ...
    self.operator = {
        ...
        "gm": function () {
            ...
            var sides = [ // these are all 23 characters long
                    ["Split them up Hard/soft"],
                    ["Put/crush them together"],
                    ["Show part of their bond"],
                    ["Show their bond tighter"],
                    ["Show their bond stressd"],
                    ["The Weather hinders you"],
                    ["Landscape obstructs you"],
                    ["Environment hinders you"],
                    ["A monster obstructs you"],
                    ["Talking NPC hinders you"],
                    ["Your past obstructs you"],
                    ["Equipment obstructs you"],
                    ["Old friend contacts you"],
                    ["An old enemy reappears "],
                    ["Announce future badness"],
                    ["If you believe, happens"],
                    ["Something good happens "],
                    ["A useful thing happens "],
                    ["You lose some equipment"],
                    ["Hurt or lose a resource"],
                    ["Find clear, cruel traps"],
                    ["Show tension escalating"],
                    ["Show what you do better"],
                    ["Show what you dream of "],
                    ["Show what you/they want"],
                    ["Someone offers paid job"],
                    ["Someone makes an offer "],
                    ["They have what you want"],
                    ["Valuable and high cost "],
                    ["another character hurts"],
